...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-342px)]">
      <div className="flex w-full max-w-sm mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-4xl my-10">
        <div
          className="hidden bg-contain bg-no-repeat bg-center lg:block lg:w-1/2"
          style={{
            backgroundImage: `url('https://i.ibb.co/9W9pspV/5098293.jpg')`,
          }}
        ></div>
