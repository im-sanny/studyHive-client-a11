          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-cyan-200">
              <p className="relative px-6 py-1 text-lg italic text-center text-gray-100 dark:text-gray-800">
                ...
                StudyHive offers a unique blend of innovation and accessibility.
                From interactive lessons to collaborative study groups, it
                caters to diverse learning styles and fosters a sense of
                belonging. I'm proud to be part of such a dynamic learning
                community.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg rounded-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-teal-200">
              <p className="relative px-6 py-1 text-lg italic text-center text-gray-100 dark:text-gray-800">
                ...
                I've tried many online learning platforms, but StudyHive stands
                out for its commitment to student success. The platform's
                commitment to excellence, coupled with its user-friendly
                interface, has made my learning journey seamless and rewarding.
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
